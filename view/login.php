...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $url = 'https://backend-akun-tcc-3klgbesmja-uc.a.run.app/login';
    $data = array(
        'username' => $username,
        'password' => $password
    );
          ...
          <div class="card-body p-5 text-center">
            <div class="mb-md-3 mt-md-4 pb-5">
              ...
              <form method="post" action="">
                  ...
                  <button class="btn btn-custom btn-lg px-5" type="submit">Masuk</button>
              </form>
            </div>

            <div>
              <p class="mb-0">Tidak punya akun? <a href="register.php" class="text-primary fw-bold">Daftar</a></p>
            </div>
