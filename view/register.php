...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($username) || empty($password)) {
        echo "<script>alert('Both username and password are required.'); window.location.href = 'register.php';</script>";
        exit();
    }
    ...
    if ($result === false) {
        echo "<script>alert('Error: Failed!'); window.location.href = 'register.php';</script>";
    } else {
        ...
        if ($response['status'] === 'success') {
            ...
            echo "<script>alert('Registration failed: $status - $errorMessage'); window.location.href = 'register.php';</script>";
        }
    }
}
?>
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            <div class="mb-md-3 mt-md-4 pb-5">
              ...
              <p class="text-muted mb-5">Masukkan username dan password anda</p>
              ...
              <form method="post" action="">
                  ...
                  <button class="btn btn-custom btn-lg px-5" type="submit">Daftar</button>
              </form>

            </div>

            <div>
              <p class="mb-0">Sudah punya akun? <a href="login.php" class="text-primary fw-bold">Masuk</a>
              </p>
            </div>
